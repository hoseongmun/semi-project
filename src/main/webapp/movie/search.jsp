...
//클릭한 페이지로 이동 기능
function list(page){
	location.href="/jsp02/movie_servlet/list.do?curPage="+page+"&search_option=${search_option}&keyword=${keyword}";
}
...
<form name="form1" method="post" action="/jsp02/movie_servlet/search.do">
