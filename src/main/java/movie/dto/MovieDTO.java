...
public class MovieDTO {
	...
	private int comment_count; //댓글 갯수, db 테이블에는 없음
	private String filename;
	private int filesize; 
	private int down; 	
	private String ext; //첨부파일의 확장자 명 처리, db테이블에는 없음
	private String show;
	public int getNum() {
		return num;
	}
	...
	public String toString() {
		return "MovieDTO [num=" + num + ", writer=" + writer + ", subject=" + subject + ", passwd=" + passwd
	...
	public MovieDTO(int num, String writer, String subject, String passwd, Date reg_date, int readcount, int ref,
